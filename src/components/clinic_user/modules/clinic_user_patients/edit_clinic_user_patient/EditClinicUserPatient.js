...
import "./EditClinicUserPatient.css";
...
const EditClinicUserPatient = () => {
  ...
  const [isOpenUpdatedPatientModal, setIsOpenUpdatedPatientModal] =
    useState(false);
  ...
  const getPatientDetails = async () => {
    ...
    await axios
      .get(
        `http://ec2-3-6-218-218.ap-south-1.compute.amazonaws.com:8080/api/v1/clinic/${clinicId}/patient/${patient_id}`,
        config
      )
      .then((res) => {
  ...
  const handleUpdatePatientToClinic = (values) => {
    const payload = {
    ...
    axios
      ...
      .then((res) => {
        setIsOpenUpdatedPatientModal(true);
    ...
    <div className="clinic-user-add-patient-main-div">
      ...
      <Row className="w-100" style={{ padding: "0 0 0 23px" }}>
        <Form
          ...
          onFinish={handleUpdatePatientToClinic}
          autoComplete="off"
          className="w-100"
        >
            ...
            <Col xs={24} sm={24} md={12} xl={6}>
                ...
                >
                  ...
                  >
                    ...
                    <Row style={{ display: "flex", flexDirection: "column" }}>
                      ...
                      <Input
                        value={"PID# " + patientUserDetails.user_id}
                        name="patient_id"
                        label="patient_id"
                        style={{
                          fontWeight: "400",
              ...
              <div
                ...
                style={{
                  ...
                  background: "#FFF",
                  padding: "26px 3.3333333333333335vw",
                }}
              >
                <Row
                  className=""
                ...
                >
                  ...
                  <Row className="w-100">
                    <Input
                      value={patientUserDetails.username}
      ...
      <Modal
        width={"647px"}
        open={isOpenUpdatedPatientModal}
        closable={false}
        footer={false}
        centered
        destroyOnClose={true}
        ...
        >
          ...
          <Row className="d-flex jc-center">
            <Button
              ...
              onClick={() => {
                setIsOpenUpdatedPatientModal(false);
                // setLoading(true);
...
export default EditClinicUserPatient;
