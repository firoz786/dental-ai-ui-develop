...
import addpatientberadcrumb from "../../../../../assets/add-patient-beradcrumb.png";
    ...
    <div className="clinic-user-add-patient-main-div">
      ...
      >
        ...
        >
          ...
          <Breadcrumb>
            <Breadcrumb.Item>
              <a href={routes_clinic_admin_patients}>Patients</a>
            </Breadcrumb.Item>
            <Breadcrumb.Item>Add Patient</Breadcrumb.Item>
          </Breadcrumb>
        </Row>
        <Input
          style={{
